...
* `TransferFromPermit2`: Approve the Permit2 contract and use the `Permit2` utility from the encoding crate to build and sign the `PermitSingle`. The encoder does not produce the permit.
