...
1. Implement the <a href="https://github.com/propeller-heads/tycho-indexer/blob/main/protocols/adapter-integration/evm/src/interfaces/ISwapAdapter.sol" target="_blank" rel="noopener noreferrer">`ISwapAdapter.sol`</a> interface.
