...
{% hint style="info" %}
Note: this implementation pattern is, by default, used in the [ethereum-template-factory](https://github.com/propeller-heads/tycho-indexer/tree/main/protocols/substreams/ethereum-template-factory) template.
{% endhint %}
