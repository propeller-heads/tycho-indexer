...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct AllProtocolFeesOwed {}
    impl AllProtocolFeesOwed {
        const METHOD_ID: [u8; 4] = [1u8, 117u8, 4u8, 182u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for AllProtocolFeesOwed {
        const NAME: &'static str = "allProtocolFeesOwed";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl AllTokens {
        const METHOD_ID: [u8; 4] = [111u8, 249u8, 127u8, 29u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for AllTokens {
        const NAME: &'static str = "allTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<Vec<u8>>> for AllTokens {
    ...
    pub struct Balances {}
    impl Balances {
        const METHOD_ID: [u8; 4] = [123u8, 185u8, 138u8, 104u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    pub struct Burn {
        pub payer: Vec<u8>,
        pub receiver: Vec<u8>,
        pub lp_amount: substreams::scalar::BigInt,
        pub deadline: substreams::scalar::BigInt,
        pub unwrap: bool,
    }
    impl Burn {
        const METHOD_ID: [u8; 4] = [104u8, 99u8, 245u8, 188u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.lp_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Bool(self.unwrap.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    pub struct BurnSwap {
        ...
        pub receiver: Vec<u8>,
        pub lp_amount: substreams::scalar::BigInt,
        pub output_token_index: substreams::scalar::BigInt,
        pub min_amount_out: substreams::scalar::BigInt,
        pub deadline: substreams::scalar::BigInt,
        pub unwrap: bool,
    }
    impl BurnSwap {
        const METHOD_ID: [u8; 4] = [150u8, 215u8, 91u8, 246u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.output_token_index.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for BurnSwap {
    ...
    impl CollectProtocolFees {
        const METHOD_ID: [u8; 4] = [161u8, 175u8, 91u8, 154u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl Denominators {
        const METHOD_ID: [u8; 4] = [1u8, 124u8, 246u8, 97u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Denominators {
        const NAME: &'static str = "denominators";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Fees {}
    impl Fees {
        const METHOD_ID: [u8; 4] = [154u8, 241u8, 211u8, 90u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Fees {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct FlashFeePpm {}
    impl FlashFeePpm {
        const METHOD_ID: [u8; 4] = [49u8, 89u8, 106u8, 106u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for FlashFeePpm {
        const NAME: &'static str = "flashFeePpm";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
            ...
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.token_addr),
                    ),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
    ...
    pub struct InitialMint {
        pub receiver: Vec<u8>,
        pub lp_tokens: substreams::scalar::BigInt,
    }
    impl InitialMint {
        const METHOD_ID: [u8; 4] = [109u8, 141u8, 15u8, 243u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.lp_tokens.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for InitialMint {
        const NAME: &'static str = "initialMint";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Kill {}
    impl Kill {
        const METHOD_ID: [u8; 4] = [65u8, 192u8, 225u8, 181u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Kill {
    ...
    pub struct Killed {}
    impl Killed {
        const METHOD_ID: [u8; 4] = [31u8, 58u8, 14u8, 65u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Killed {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for Killed {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Lmsr {}
    impl Lmsr {
        const METHOD_ID: [u8; 4] = [71u8, 110u8, 68u8, 182u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
                    ...
                    &[
                        ethabi::ParamType::Tuple(
                            vec![
                                ...
                                ethabi::ParamType::Array(Box::new(ethabi::ParamType::Int(128usize)))
                            ],
                        ),
                    ],
                    data.as_ref(),
    ...
    impl substreams_ethereum::Function for Lmsr {
        const NAME: &'static str = "LMSR";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Mint {
        pub payer: Vec<u8>,
        pub funding_selector: [u8; 4usize],
        pub receiver: Vec<u8>,
        pub lp_token_amount: substreams::scalar::BigInt,
        pub deadline: substreams::scalar::BigInt,
        pub cb_data: Vec<u8>,
    }
    impl Mint {
        const METHOD_ID: [u8; 4] = [251u8, 244u8, 10u8, 124u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.payer)),
                    ethabi::Token::FixedBytes(self.funding_selector.as_ref().to_vec()),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.receiver)),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.lp_token_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Bytes(self.cb_data.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl NumTokens {
        const METHOD_ID: [u8; 4] = [142u8, 73u8, 155u8, 207u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for NumTokens {
        const NAME: &'static str = "numTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Swap {
        ...
        pub funding_selector: [u8; 4usize],
        pub receiver: Vec<u8>,
        pub input_token_index: substreams::scalar::BigInt,
        pub output_token_index: substreams::scalar::BigInt,
    ...
    impl Swap {
        const METHOD_ID: [u8; 4] = [74u8, 233u8, 62u8, 29u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.input_token_index.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    pub struct SwapMint {
        ...
        pub input_token_index: substreams::scalar::BigInt,
        pub max_amount_in: substreams::scalar::BigInt,
        pub min_lp_out: substreams::scalar::BigInt,
        pub deadline: substreams::scalar::BigInt,
        pub cb_data: Vec<u8>,
    }
    impl SwapMint {
        const METHOD_ID: [u8; 4] = [205u8, 10u8, 65u8, 152u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.min_lp_out.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for SwapMint {
    ...
    impl Token {
        const METHOD_ID: [u8; 4] = [4u8, 66u8, 21u8, 198u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl WrapperToken {
        const METHOD_ID: [u8; 4] = [13u8, 36u8, 98u8, 20u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for WrapperToken {
        const NAME: &'static str = "wrapperToken";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for WrapperToken {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    pub struct Burn {
        ...
        pub lp_burned: substreams::scalar::BigInt,
    }
    impl Burn {
        const TOPIC_ID: [u8; 32] = [
            63u8,
    ...
    pub struct Mint {
        ...
        pub receiver: Vec<u8>,
        pub amounts: Vec<substreams::scalar::BigInt>,
        pub lp_minted: substreams::scalar::BigInt,
    }
    impl Mint {
        const TOPIC_ID: [u8; 32] = [
            107u8,
    ...
    impl substreams_ethereum::Event for ProtocolFeesCollected {
        const NAME: &'static str = "ProtocolFeesCollected";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
