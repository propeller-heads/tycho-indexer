...
/// Request body for fetching snapshots of protocol states and contract states.
///
/// This combines multiple data sources into a single request:
/// - Protocol states for the specified components
/// - Contract states (VM storage) for the specified contracts
/// - Component TVL (if requested)
/// - Traced entry points (if chain is Ethereum)
...
pub struct SnapshotRequestResponse {
    ...
    #[schema(value_type=HashMap<String, ResponseAccount>)]
