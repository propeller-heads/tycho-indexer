...
pub mod conversation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn converse(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::UserInput>,
        ) -> Result<
            tonic::Response<tonic::codec::Streaming<super::SystemOutput>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sf.codegen.conversation.v1.ConversationService/Converse",
            );
        ...
        pub async fn discover(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sf.codegen.conversation.v1.ConversationService/Discover",
            );
