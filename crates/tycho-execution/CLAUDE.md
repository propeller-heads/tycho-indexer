...
increasing per trader) do not encode in parallel with each other: they share one thread and encode sequentially
in route order, while the remaining groups still encode in parallel alongside them.
