...
contract Analyzer {
    ...
    /// @return transferInOk    Whether transfer(settlement, amount) returned true without reverting.
    ...
    function analyze(
        ...
        // Transfer from holder (this address, which has the actual balance) to settlement.
        uint256 g1 = gasleft();
