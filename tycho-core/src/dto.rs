...
pub enum WebSocketMessage {
    BlockChanges { subscription_id: Uuid, deltas: BlockAggregatedChanges },
    Response(Response),
}
...
mod test {
    ...
    fn test_block_account_changes_merge() {
        ...
        let block_account_changes_initial = BlockAggregatedChanges::new(
            "extractor1",
            Chain::Ethereum,
            Block::default(),
            0,
        ...
        let block_account_changes_new = BlockAggregatedChanges::new(
            "extractor2",
            Chain::Ethereum,
            Block::default(),
            0,
        ...
        .into_iter()
        .collect();
        let block_account_changes_expected = BlockAggregatedChanges::new(
            "extractor1",
            Chain::Ethereum,
            Block::default(),
            0,
