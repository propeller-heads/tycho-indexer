...
* Deploy executors and router for Ethereum, Base and Unichain ([1ce76b4](https://github.com/propeller-heads/tycho-execution/commit/1ce76b47d0114f6bfe32e669f743189460ad99ce))

## [0.43.0](https://github.com/propeller-heads/tycho-execution/compare/0.42.0...0.43.0) (2026-03-19)


### Features

* Deploy executors and router for Base and Ethereum ([126ca48](https://github.com/propeller-heads/tycho-execution/commit/126ca481194b9971a399548034be045452db1de2))

## [0.42.0](https://github.com/propeller-heads/tycho-execution/compare/0.41.0...0.42.0) (2026-03-18)


### Features

* Everytime there is a transfer double check with balances the actual amount received ([6fef32b](https://github.com/propeller-heads/tycho-execution/commit/6fef32bcca8f76da61f988e0210a0f00c398ad77))


### Bug Fixes

* post-rebase error - remove redundant balance check ([bca642e](https://github.com/propeller-heads/tycho-execution/commit/bca642e62afd6403a5070eb6a9b842ffb7ff8023))
* Remove FoT logic for univ2 and univ4 ([a4c1177](https://github.com/propeller-heads/tycho-execution/commit/a4c117758909c9b752d2246e05fdd41c69147bbb))
* Smother slither ([b123329](https://github.com/propeller-heads/tycho-execution/commit/b1233297d03dcd923501d8451da1bf1d31b072d5))

## [0.41.0](https://github.com/propeller-heads/tycho-execution/compare/0.40.0...0.41.0) (2026-03-18)


### Features

* Add tokenOut and outputToRouter to getTransferData ([1ce14c5](https://github.com/propeller-heads/tycho-execution/commit/1ce14c53068dad41445208fe08dce131d644f3a5))
* Perform balance checks in dispatcher ([a6b0276](https://github.com/propeller-heads/tycho-execution/commit/a6b0276bc17df43dcc86cfa501e8ebb27b7c2a9f))
* Remove target validation from executors ([54d798a](https://github.com/propeller-heads/tycho-execution/commit/54d798ae7d1bc331b25c74a85fc0e73eb7c9ee7d))
* Remove tokenOut and amountOut from executor interface ([6dc7621](https://github.com/propeller-heads/tycho-execution/commit/6dc762187f2d3d6b5e80c35433e2cb2503700dea))


### Bug Fixes

* Add router test for stETH through Curve ([aa78a61](https://github.com/propeller-heads/tycho-execution/commit/aa78a61cbbbfe4bad846d9cee8fe725548e6a61e))
* Set Etherfi outputToRouter = false when eethToEth ([740cb13](https://github.com/propeller-heads/tycho-execution/commit/740cb1323b0324026eb654d797a6b5050abe67ce))

## [0.40.0](https://github.com/propeller-heads/tycho-execution/compare/0.39.4...0.40.0) (2026-03-18)


### Features

* Claude skill to compare gas between branches ([ccb7b34](https://github.com/propeller-heads/tycho-execution/commit/ccb7b34ffbcf961eb7dd094ec40349c4f06da43f))

## [0.39.4](https://github.com/propeller-heads/tycho-execution/compare/0.39.3...0.39.4) (2026-03-16)


### Bug Fixes

* Add target verification for Fluid ([4cd0d83](https://github.com/propeller-heads/tycho-execution/commit/4cd0d83b7674f44ddce6c368c1cc8c28c1238143))
* False ERC4626 vault exploit ([4a7b53f](https://github.com/propeller-heads/tycho-execution/commit/4a7b53f40f68ccee74775f212b87fe89319f42ea))
* Use balance check for FluidV1 instead of validation ([1b34ac3](https://github.com/propeller-heads/tycho-execution/commit/1b34ac3dbff85532691596a47efa341a2fe73fe9))

## [0.39.3](https://github.com/propeller-heads/tycho-execution/compare/0.39.2...0.39.3) (2026-03-13)


### Bug Fixes

* Remove client params from Solution ([32b04b7](https://github.com/propeller-heads/tycho-execution/commit/32b04b7aadcc50c02b88d7d51cae686f5338486c))

## [0.39.2](https://github.com/propeller-heads/tycho-execution/compare/0.39.1...0.39.2) (2026-03-13)


### Bug Fixes

* Remove exact_out from Solution ([d73b812](https://github.com/propeller-heads/tycho-execution/commit/d73b8124b0ae500b4182a283c79c9f0dea17519e))

## [0.39.1](https://github.com/propeller-heads/tycho-execution/compare/0.39.0...0.39.1) (2026-03-10)


### Bug Fixes

* Remove profile_encoding.rs ([e87a925](https://github.com/propeller-heads/tycho-execution/commit/e87a9258e961fe38022bd1e3c2fa4b6de1460f8a))
* upgrade quinn-proto to 0.11.14 to fix DoS vulnerability ([dccc041](https://github.com/propeller-heads/tycho-execution/commit/dccc0416d157af839b3cd4400fb2dcda241b5e5e))

## [0.39.0](https://github.com/propeller-heads/tycho-execution/compare/0.38.0...0.39.0) (2026-03-09)


### Features

* Flag if FoT token for USV2/4 ([b16fbdb](https://github.com/propeller-heads/tycho-execution/commit/b16fbdb3770141ffac17e48eb3c5bf1e1ef3d975))

## [0.38.0](https://github.com/propeller-heads/tycho-execution/compare/0.37.0...0.38.0) (2026-03-09)


### Features

* Add UserTransferType to Solution instead of Encoder ([9d5dc37](https://github.com/propeller-heads/tycho-execution/commit/9d5dc3788e4b0941df024b066a837d816b80c279))

## [0.37.0](https://github.com/propeller-heads/tycho-execution/compare/0.36.0...0.37.0) (2026-03-09)


### Features

* Bring back Uniswap X code and docs (from tycho-execution) ([53014ec](https://github.com/propeller-heads/tycho-execution/commit/53014ec568937dd510d8d44e8a9e56318769fb68))
* port changes from tycho-execution post-fork ([cc36b1f](https://github.com/propeller-heads/tycho-execution/commit/cc36b1ff320b765d2e4c02d77e60a40acd49a47e))


### Bug Fixes

* Update calldata.txt after rebase with main ([bb3f4ef](https://github.com/propeller-heads/tycho-execution/commit/bb3f4efef5b29089afdbd2c806f0fd6887311d12))
* Upgrade dependencies to make cargo audit happy ([218c76b](https://github.com/propeller-heads/tycho-execution/commit/218c76be7df7771e91b570ba84e3071bcc40d4a6))

## [0.36.0](https://github.com/propeller-heads/tycho-execution/compare/0.35.0...0.36.0) (2026-03-06)


### Features

* Support FoT Tokens in USV2 ([e02bcfb](https://github.com/propeller-heads/tycho-execution/commit/e02bcfbc0e86005d1fef87a2836790a1b48e97ce))
* Support FoT tokens in USV4 ([1c9786a](https://github.com/propeller-heads/tycho-execution/commit/1c9786a956deb5c716dcdae5d07498c499dc76c4))

## [0.35.0](https://github.com/propeller-heads/tycho-execution/compare/0.34.0...0.35.0) (2026-03-06)


### Features

* Add Ekubo V3 ([9ea4651](https://github.com/propeller-heads/tycho-execution/commit/9ea4651d41f2a11f5e2835d3e6485183b1783f5d))
* Add EtherFi ([8da9bcb](https://github.com/propeller-heads/tycho-execution/commit/8da9bcb4389404b1cdb87850c9d222c900a4063b))
* Upgrade Rocketpool ([ef16c0f](https://github.com/propeller-heads/tycho-execution/commit/ef16c0fa0acd456334fdd944791137b7d2510ca5))


### Bug Fixes

* Add EkuboV3Executor to deploy-executors.js ([b311328](https://github.com/propeller-heads/tycho-execution/commit/b311328423c24475a844724ecdb75dd642a3855e))
* In EtherfiExecutor, return msg.sender instead of address(this) ([2a39ce1](https://github.com/propeller-heads/tycho-execution/commit/2a39ce1a5836a2f412e7083f07c816767e0f42eb))

## [0.34.0](https://github.com/propeller-heads/tycho-execution/compare/0.33.0...0.34.0) (2026-03-05)


### Features

* Credit output to vault if receiver is TychoRouter ([3458a35](https://github.com/propeller-heads/tycho-execution/commit/3458a353e7d69553554d13581ebc38d88a623687))
* Require EIP-712 client signature on fee params ([ef46a57](https://github.com/propeller-heads/tycho-execution/commit/ef46a574bbbed31f8d4ea3e058d4ce1cb818bbe4))


### Bug Fixes

* After rebase fixes ([281b0eb](https://github.com/propeller-heads/tycho-execution/commit/281b0ebebd95930cccfe941215fdbc8b5aef93f3))
* After rebase with main fixes ([22fe05d](https://github.com/propeller-heads/tycho-execution/commit/22fe05d53fa337ccac798d30a7e65bb0bdcd412b))
* Don't do transfers unnecessarily ([59eb609](https://github.com/propeller-heads/tycho-execution/commit/59eb609b11076c3f7d9545f5962ef1cd1b8b3f9e))
* Remove deprecated method encode_full_calldata ([58b6a78](https://github.com/propeller-heads/tycho-execution/commit/58b6a785d02cfba21984559f403fcf4b9ddb97d5))

## [0.33.0](https://github.com/propeller-heads/tycho-execution/compare/0.32.0...0.33.0) (2026-03-04)


### Features

* Emit FeesTaken ([b73394d](https://github.com/propeller-heads/tycho-execution/commit/b73394db6f3553e1cb8ed3871309ef1e1157e739))

## [0.32.0](https://github.com/propeller-heads/tycho-execution/compare/0.31.0...0.32.0) (2026-02-27)


### Features

* add test which includes wrapping ([fe67481](https://github.com/propeller-heads/tycho-execution/commit/fe674819a554b0158eefc988d8d4052e88911d27))
* replace mock eth executor with a real one ([7edf724](https://github.com/propeller-heads/tycho-execution/commit/7edf7243a3c55d4787cbf989a5473260ed8d93a5))

## [0.31.0](https://github.com/propeller-heads/tycho-execution/compare/0.30.0...0.31.0) (2026-02-26)


### Features

* remove unneeded set-executors script and update README instructions ([b5e55d6](https://github.com/propeller-heads/tycho-execution/commit/b5e55d65d653b7dbc729fb3b729e73bbc4032ba7))

## [0.30.0](https://github.com/propeller-heads/tycho-execution/compare/0.29.0...0.30.0) (2026-02-24)


### Features

* regenerate calldata ([092947b](https://github.com/propeller-heads/tycho-execution/commit/092947bfdd0722b6d754859b80a3aa499b25af94))
* remove lido ([3232446](https://github.com/propeller-heads/tycho-execution/commit/323244677acdd78180d2518748a2842c045a49e8))
* update executor index ([00a5567](https://github.com/propeller-heads/tycho-execution/commit/00a5567969d8d0222e2895d818d6b8cf0e947ae3))

## [0.29.0](https://github.com/propeller-heads/tycho-execution/compare/0.28.1...0.29.0) (2026-02-23)


### Features

* add function to insert missing (un)wrapping swaps ([c5e9d7d](https://github.com/propeller-heads/tycho-execution/commit/c5e9d7df889574e2f3f48ee40abbb89417197ceb))
* add protocol system check and comments for tests ([9bb1b67](https://github.com/propeller-heads/tycho-execution/commit/9bb1b67a458d0b4f429220dba413c538c7936675))
* add sequential wETH test where wrapping swap is added automatically ([45150b3](https://github.com/propeller-heads/tycho-execution/commit/45150b382b0c9601cb772a0ff7b1de4a3073c400))
* add test for unwrapping in weth executor ([f46ee8f](https://github.com/propeller-heads/tycho-execution/commit/f46ee8f36bef93436c7b4ca4403bd255d6ba1a6b))
* add test to check there is no unneeded swap added ([50ff35a](https://github.com/propeller-heads/tycho-execution/commit/50ff35af380caa1c8eb8cbec99ff66a553a2ee55))
* add tests for executor ([e519893](https://github.com/propeller-heads/tycho-execution/commit/e519893f1747265e50e28483cd53a5a4d35301c4))
* add TychoRouterTestSetup for wethWrapTest ([d9b2d17](https://github.com/propeller-heads/tycho-execution/commit/d9b2d17708296d14b947bad7a7c7892e60b7048e))
* add weth address via constructor ([cc7390e](https://github.com/propeller-heads/tycho-execution/commit/cc7390efcb0bfce4fa4c8236db465a253f520ee1))
* add weth executor ([0172ab3](https://github.com/propeller-heads/tycho-execution/commit/0172ab366f6a213b5d46a67d80dabe0b0a10a752))
* add Weth executor ([c5f9303](https://github.com/propeller-heads/tycho-execution/commit/c5f93031f0740f159f9d71398be4c175288fc03c))
* add weth protocol integration test ([5042ebd](https://github.com/propeller-heads/tycho-execution/commit/5042ebde5db4eb75c86eaa74349a12ebdaa8b452))
* add weth swap encoder ([8829b7e](https://github.com/propeller-heads/tycho-execution/commit/8829b7ed80da5837f71fef1d7751bd01d8b13a6d))
* update receiver due to interacting with the  token directly instead of a pool ([152042f](https://github.com/propeller-heads/tycho-execution/commit/152042f919dcbf7d0aee02152e614b7502920148))


### Bug Fixes

* fix the test setup ([7bb3bd7](https://github.com/propeller-heads/tycho-execution/commit/7bb3bd7b6f530e5c92396d61ba3ad66e217eace5))
* get chain from the correct source for TychoExecutorEncoder ([befbeb7](https://github.com/propeller-heads/tycho-execution/commit/befbeb72d112da9ad42bb76cfe26932f9fcad918))
* remove unneeded mutability ([6ee938f](https://github.com/propeller-heads/tycho-execution/commit/6ee938f23b86884397095e7635d39166056f84bf))
* remove unneeded setup ([90a49a9](https://github.com/propeller-heads/tycho-execution/commit/90a49a984de7beac030185cead7ddea41d006d83))
* remove unwrap ([24fffd9](https://github.com/propeller-heads/tycho-execution/commit/24fffd9bf3a91a45e908d2f6008d588f23339f13))
* revert change in the test for deprecated method ([c6bb544](https://github.com/propeller-heads/tycho-execution/commit/c6bb5444e09636856dd3a1c975cd596c9e3710b2))
* update test with the correct value ([fd8aedf](https://github.com/propeller-heads/tycho-execution/commit/fd8aedf2e005d4209e342e79cc899f9459702731))
* update transfer type ([5e653cd](https://github.com/propeller-heads/tycho-execution/commit/5e653cd38f0ef72cdd632783444601ccbc77b149))

## [0.28.1](https://github.com/propeller-heads/tycho-execution/compare/0.28.0...0.28.1) (2026-02-20)


### Bug Fixes

* Avoid unnecessary approval token protocols like RETH ([97e5574](https://github.com/propeller-heads/tycho-execution/commit/97e5574f4bbf80d6d334914b70f956fce4a0d7b8))

## [0.28.0](https://github.com/propeller-heads/tycho-execution/compare/0.27.0...0.28.0) (2026-02-19)


### Features

* Safer role handling ([9456c21](https://github.com/propeller-heads/tycho-execution/commit/9456c219a10a4683380c2e7714a2828a39a16d9f))

## [0.27.0](https://github.com/propeller-heads/tycho-execution/compare/0.26.0...0.27.0) (2026-02-19)


### Features

* add test for existing executor ([c829f3e](https://github.com/propeller-heads/tycho-execution/commit/c829f3ef0f366de682040c879ae8accd33b0f993))
* make expiration of the timelock obvious for users ([9bd0961](https://github.com/propeller-heads/tycho-execution/commit/9bd0961e62797bdfae9038117da376234c3d8841))
* revert if the executor already exists ([be7d1c1](https://github.com/propeller-heads/tycho-execution/commit/be7d1c1ffcd9c8834671085292aa61334c37f34a))

## [0.26.0](https://github.com/propeller-heads/tycho-execution/compare/0.25.4...0.26.0) (2026-02-16)


### Features

* Make additional methods pausable ([9dad21c](https://github.com/propeller-heads/tycho-execution/commit/9dad21c7f3d3347e1004209186cd235fa730b51e))

## [0.25.4](https://github.com/propeller-heads/tycho-execution/compare/0.25.3...0.25.4) (2026-02-13)


### Bug Fixes

* Ensure feeCalculator and permit2 are contracts ([a6c11dc](https://github.com/propeller-heads/tycho-execution/commit/a6c11dcce26d684e296e79afa31c638d8e537076))

## [0.25.3](https://github.com/propeller-heads/tycho-execution/compare/0.25.2...0.25.3) (2026-02-04)

## [0.25.2](https://github.com/propeller-heads/tycho-execution/compare/0.25.1...0.25.2) (2026-02-04)

## [0.25.1](https://github.com/propeller-heads/tycho-execution/compare/0.25.0...0.25.1) (2026-02-04)

## [0.25.0](https://github.com/propeller-heads/tycho-execution/compare/0.24.2...0.25.0) (2026-02-04)


### Features

* add missing values for router deployment in the script ([1d41b69](https://github.com/propeller-heads/tycho-execution/commit/1d41b6955be370af00062e644e16255693c62c62))
* add timelock for new executors ([eb3c613](https://github.com/propeller-heads/tycho-execution/commit/eb3c61369750d359a59fdfc94a17e00d56bb1a34))
* set delay for the executor activation in the constructor ([40ffb3b](https://github.com/propeller-heads/tycho-execution/commit/40ffb3bbfaf7b745fadbb74ad05fe3ce3eaae6cc))

## [0.24.2](https://github.com/propeller-heads/tycho-execution/compare/0.24.1...0.24.2) (2026-02-04)

## [0.24.1](https://github.com/propeller-heads/tycho-execution/compare/0.24.0...0.24.1) (2026-02-03)

## [0.24.0](https://github.com/propeller-heads/tycho-execution/compare/0.23.1...0.24.0) (2026-02-03)


### Features

* Check for fees before calling calculator ([402567c](https://github.com/propeller-heads/tycho-execution/commit/402567cec0ce3de0955b8c38f17bc974c2671ee1))
* Optimize USV2 gas by passing tokens ([78d8ca5](https://github.com/propeller-heads/tycho-execution/commit/78d8ca5289b0e959b07b97a6484eab84f4159f36))

## [0.23.1](https://github.com/propeller-heads/tycho-execution/compare/0.23.0...0.23.1) (2026-02-02)


### Bug Fixes

* Compute final receiver for split swap too (BUG) ([9c7ba34](https://github.com/propeller-heads/tycho-execution/commit/9c7ba34ef19fa8195287d6aaa5573ac244206f92))

## [0.23.0](https://github.com/propeller-heads/tycho-execution/compare/0.22.0...0.23.0) (2026-02-02)


### Features

* Force FeeCalculator to be passed in TychoRouter constructor ([e02cdf8](https://github.com/propeller-heads/tycho-execution/commit/e02cdf8922b038d8c40943f8e5c4b4c64925220a))
* Get rid of ProtocolType and do canReceiveFromPreviousSwap instead ([c5c0e46](https://github.com/propeller-heads/tycho-execution/commit/c5c0e46b387bd4de2f24a57fb1fc9cc0675ecc03))
* Handle receiver in RFQs ([9176a1c](https://github.com/propeller-heads/tycho-execution/commit/9176a1c922f23970fe6dbb71cfb3107ac49a4980))
* No longer encoding swap receiver ([ec1dd19](https://github.com/propeller-heads/tycho-execution/commit/ec1dd19cf3cb969ba1ecf6d278ddca3a45522175))
* Optimize receiver of last swap in split swaps ([b0a9099](https://github.com/propeller-heads/tycho-execution/commit/b0a9099f9f47a275fe1311e6b582c8a75d9def52))
* Remove receiver logic from encoding ([8033027](https://github.com/propeller-heads/tycho-execution/commit/80330274f5de191ba942e7351a2a94c86e1039c6))


### Bug Fixes

* Improve _sequentialSwap method ([ca04c46](https://github.com/propeller-heads/tycho-execution/commit/ca04c4617f326b679c285b8cebf8bfb8937ac183))
* Return msg.sender in canReceiveFromPreviousSwap instead of address(0) ([763c75d](https://github.com/propeller-heads/tycho-execution/commit/763c75df83394f6189cc261e883eb9cf80f84732))

## [0.22.0](https://github.com/propeller-heads/tycho-execution/compare/0.21.1...0.22.0) (2026-01-29)


### Features

* Do not encode transferTypes ([4f37d05](https://github.com/propeller-heads/tycho-execution/commit/4f37d05ed4f24c77de2309ac6a6ea4ebc28f1274))

## [0.21.1](https://github.com/propeller-heads/tycho-execution/compare/0.21.0...0.21.1) (2026-01-28)


### Bug Fixes

* Remove option for uniswap_v4_hooks encoder entirely ([6ad4eeb](https://github.com/propeller-heads/tycho-execution/commit/6ad4eeb7b791e92ce9eb0033a6bb76cc54621265))
* Remove uniswap_v4_hooks for base and unichain as well ([99f6ac2](https://github.com/propeller-heads/tycho-execution/commit/99f6ac22d34446222696f52b0d07277b0fd01eaf))

## [0.21.0](https://github.com/propeller-heads/tycho-execution/compare/0.20.0...0.21.0) (2026-01-27)


### Features

* Separate methods for using Vault ([50b515e](https://github.com/propeller-heads/tycho-execution/commit/50b515e6b7eeab8590a54c9bc73396f496edd54f))

## [0.20.0](https://github.com/propeller-heads/tycho-execution/compare/0.19.0...0.20.0) (2026-01-26)


### Features

* Optimize last transfer (if possible) ([0a86b7a](https://github.com/propeller-heads/tycho-execution/commit/0a86b7a5797c9ea6ccd9f1a3e3f7d875d7a09ec6))


### Bug Fixes

* After rebase with main fixes ([0bb26ae](https://github.com/propeller-heads/tycho-execution/commit/0bb26aea381028267f3b27810eb9897d24123efc))

## [0.19.0](https://github.com/propeller-heads/tycho-execution/compare/0.18.1...0.19.0) (2026-01-26)


### Features

* Fix circular swap vulnerability with InputSource guardrail ([55688b2](https://github.com/propeller-heads/tycho-execution/commit/55688b283dc2601ef1f8aee1610d1816c9658a01))
* Support arbitrage swaps starting from vault ([8d9c5d2](https://github.com/propeller-heads/tycho-execution/commit/8d9c5d2fd6e92103fac15676388affbeb4726990))


### Bug Fixes

* After merge with main fixes ([069e5e6](https://github.com/propeller-heads/tycho-execution/commit/069e5e64d5ce666add9aa176705e7f8ef9bced3e))
* Rust fmt ([fdfeb9f](https://github.com/propeller-heads/tycho-execution/commit/fdfeb9f01a787658126f8ce8ee5ee722cfeeb283))

## [0.18.1](https://github.com/propeller-heads/tycho-execution/compare/0.18.0...0.18.1) (2026-01-26)


### Bug Fixes

* Aim to have all balance deltas 0 at the end of the swap ([bb23aaa](https://github.com/propeller-heads/tycho-execution/commit/bb23aaa75aaaa4da3a6f2f379bf6af4d6543c345))
* Handle ETH properly in Curve, Univ4 and Ekubo ([a421a46](https://github.com/propeller-heads/tycho-execution/commit/a421a4668797eeaa8c3b650d00b2638fc84d65b0))

## [0.18.0](https://github.com/propeller-heads/tycho-execution/compare/0.17.0...0.18.0) (2026-01-26)


### Features

* improve Uniswap V3 encoding ([981cfe4](https://github.com/propeller-heads/tycho-execution/commit/981cfe45b10e18e13ed168e498a3f8108fc35acd))
* uodate tests ([4817e43](https://github.com/propeller-heads/tycho-execution/commit/4817e43d92f7498405d4bee473440022cbac2d73))


### Bug Fixes

* fix tests acciording to the field order change ([4c51415](https://github.com/propeller-heads/tycho-execution/commit/4c51415f71c00c368d7806a0f424771f1e3f66e2))

## [0.17.0](https://github.com/propeller-heads/tycho-execution/compare/0.16.0...0.17.0) (2026-01-22)


### Features

* Remove final output transfer optimization ([57a13ec](https://github.com/propeller-heads/tycho-execution/commit/57a13ece387ed7c27ea4ba27a061781888234b06))

## [0.16.0](https://github.com/propeller-heads/tycho-execution/compare/0.15.0...0.16.0) (2026-01-22)


### Features

* Introduce max solver contribution ([cd60de5](https://github.com/propeller-heads/tycho-execution/commit/cd60de55b6690c913f78f03eb653d198095f3ef2))
* Rename given_token/amount -> token/amount_in and checked_amount -> min_amount_out ([14853af](https://github.com/propeller-heads/tycho-execution/commit/14853afeafc544ddfcc02a67ad3f2f82bc84d93a))

## [0.15.0](https://github.com/propeller-heads/tycho-execution/compare/0.14.0...0.15.0) (2026-01-22)


### Features

* track wei remainder from stETH share-to-ETH cast ([3be2ed6](https://github.com/propeller-heads/tycho-execution/commit/3be2ed6770cc695b04b71091b2fca7e65937a3d8))


### Bug Fixes

* fix nesting of the casting logic ([3f346f7](https://github.com/propeller-heads/tycho-execution/commit/3f346f7607f3c864dd769a1c5f5b3e454fc4329e))

## [0.14.0](https://github.com/propeller-heads/tycho-execution/compare/0.13.0...0.14.0) (2026-01-21)


### Features

* call _finalizeBalances, check for native ETH in msg.value ([ac41956](https://github.com/propeller-heads/tycho-execution/commit/ac4195650642563cb51ba628005ee985eb621a7b))
* Take fees in TychoRouter ([c31c9a8](https://github.com/propeller-heads/tycho-execution/commit/c31c9a8e1fd29788b15324c794f5dba40bdf30ff))


### Bug Fixes

* fee subtraction in calculator ([a0cb3f0](https://github.com/propeller-heads/tycho-execution/commit/a0cb3f0391714e9a55cad975e05a9d7e9378535b))
* silence slither warnings with comment ([cd7082c](https://github.com/propeller-heads/tycho-execution/commit/cd7082c32580a53dcb6ba8095844f7a8562e201a))

## [0.13.0](https://github.com/propeller-heads/tycho-execution/compare/0.12.0...0.13.0) (2026-01-21)


### Features

* add test for balance when router is the receiver ([741e194](https://github.com/propeller-heads/tycho-execution/commit/741e19449ed3e4af734a62c5d85b5e40101a3c91))
* credit vault after each swap if tokens stay in router ([fe11d83](https://github.com/propeller-heads/tycho-execution/commit/fe11d839e127c95bc248738becf57f937e0e2f91))


### Bug Fixes

* override supportsInterface for AccessControl and ERC6909 ([454f6e6](https://github.com/propeller-heads/tycho-execution/commit/454f6e679684152160d1fceca8e4dc77353e4a2a))

## [0.12.0](https://github.com/propeller-heads/tycho-execution/compare/0.11.1...0.12.0) (2026-01-20)


### Features

* Remove approval_needed from encoding and executors ([12ce178](https://github.com/propeller-heads/tycho-execution/commit/12ce17872362d819176d0cdf57450aaf799559a5))
* Rename UserTransferType::None -> UserTransferType::UseVaultsFunds ([9126678](https://github.com/propeller-heads/tycho-execution/commit/91266782f8a20b6ebf386922e93c4bb38057c5a6))
* Use new TransferTypes for router v3 ([e1d3edb](https://github.com/propeller-heads/tycho-execution/commit/e1d3edb8db23daabbb72fa7f1c97604739aba4a6))


### Bug Fixes

* Fixes after rebase with main ([c9c446e](https://github.com/propeller-heads/tycho-execution/commit/c9c446edc0a67edf26d28f07b5eba738b15c96e3))
* Simplify Bebop encoding (unsupported ETH swaps) ([d57a383](https://github.com/propeller-heads/tycho-execution/commit/d57a383e2f894441a45369e4db45ee7d570f47a3))

## [0.11.1](https://github.com/propeller-heads/tycho-execution/compare/0.11.0...0.11.1) (2026-01-20)

## [0.11.0](https://github.com/propeller-heads/tycho-execution/compare/0.10.0...0.11.0) (2026-01-20)


### Features

* [temp fix] add slither filter ([f79a11f](https://github.com/propeller-heads/tycho-execution/commit/f79a11f66da605d5b3264afeda5450a12091a3fa))
* Do Vault accounting in FeeTaker.sol ([4b149c0](https://github.com/propeller-heads/tycho-execution/commit/4b149c05e253c961c403d068af1173e4e69000b2))
* Implement FeeTaker ([b293bda](https://github.com/propeller-heads/tycho-execution/commit/b293bdad65879ecec3add621c959b8c58d9e264d))
* Move fee setting methods into FeeTaker.sol ([0bb992a](https://github.com/propeller-heads/tycho-execution/commit/0bb992a4fc6d3c03713221b53260d0211bfc69e3))
* No accounting in FeeTaker ([498fa32](https://github.com/propeller-heads/tycho-execution/commit/498fa32430fdebff66fe04b31065804b2754fb5e))
* replace _decodeFeeData with _getFeeInfo ([41b8891](https://github.com/propeller-heads/tycho-execution/commit/41b88911bbb5339c170d6fb6d809b2f55df1548b))
* Return array of FeeRecipient from FeeCalculator ([d5fb36d](https://github.com/propeller-heads/tycho-execution/commit/d5fb36d0683c17af3c1e1ffb859e58833379ea66))
* TychoRouter fee setter methods ([1d2fbf8](https://github.com/propeller-heads/tycho-execution/commit/1d2fbf8e6067410ad153813e6560a279c8a047ee))


### Bug Fixes

* Max fee check ([2c1e986](https://github.com/propeller-heads/tycho-execution/commit/2c1e986f411e41dc653c989303023b140788226a))
* Router fee portion should be deducted from solver fee ([ff9599d](https://github.com/propeller-heads/tycho-execution/commit/ff9599d5bb9ae79a2ccf4b77b29213cf240a57f8))
* Slither divide-before-multiply ([cd42cc5](https://github.com/propeller-heads/tycho-execution/commit/cd42cc5572a64fe0565b89e8193b6ab625d5a462))
* slither indexed address params in events ([3c19da0](https://github.com/propeller-heads/tycho-execution/commit/3c19da0dfdf4d0d38cb9341d8a9c0f56e1ae1f2b))

## [0.10.0](https://github.com/propeller-heads/tycho-execution/compare/0.9.0...0.10.0) (2026-01-20)


### Features

* (encoding) Add solver fee params to Solution object ([d4b7514](https://github.com/propeller-heads/tycho-execution/commit/d4b75140762fd471a3c2aa0895777815a570c6ab))
* pass solver fee params in main swap interfaces: ([7cffc62](https://github.com/propeller-heads/tycho-execution/commit/7cffc6259091c43c3d2431f446b07deafad51aa1))


### Bug Fixes

* update slither args and event parameters to be indexed according to the ERC20 spec ([0d1d8fa](https://github.com/propeller-heads/tycho-execution/commit/0d1d8fa7d4bae09e917ccacf558c8b2c220fc5b2))

## [0.9.0](https://github.com/propeller-heads/tycho-execution/compare/0.8.0...0.9.0) (2026-01-19)


### Features

* add assertion for final balance in testFinalizeBalances ([2d833fc](https://github.com/propeller-heads/tycho-execution/commit/2d833fc32e9e7cb72921a85fed5888d4806bcc27))
* add tests for finalizeBalances method ([c9c4112](https://github.com/propeller-heads/tycho-execution/commit/c9c4112ce6c48b34e359fdd0578bbf0c427439a7))
* implement finalizeBalances method ([d68829f](https://github.com/propeller-heads/tycho-execution/commit/d68829f8487e33b90c4c6727172d00c424cde505))


### Bug Fixes

* rename error for negative count ([197dc78](https://github.com/propeller-heads/tycho-execution/commit/197dc784939d03faa55c95d5001f9e3db86f401b))
* update slither args and event parameters to be indexed according to the ERC20 spec ([73ec132](https://github.com/propeller-heads/tycho-execution/commit/73ec1321396c5cb752708ad4c949315211ad7cb1))

## [0.8.0](https://github.com/propeller-heads/tycho-execution/compare/0.7.0...0.8.0) (2026-01-15)


### Features

* TychoRouter fee setter methods ([418d8ac](https://github.com/propeller-heads/tycho-execution/commit/418d8ac72e3ea15bdac0cf54def3f91c048a7997))

## [0.7.0](https://github.com/propeller-heads/tycho-execution/compare/0.6.0...0.7.0) (2026-01-15)


### Features

* Move transfers to the Dispatcher ([9c5945f](https://github.com/propeller-heads/tycho-execution/commit/9c5945fe0d56ef5d918a6e112a4fa70398c2d38f))


### Bug Fixes

* Address PR comments: ([853aaeb](https://github.com/propeller-heads/tycho-execution/commit/853aaebfed70caef09aebdcee802b4b497b1dc29))
* After merge with main fixes ([5228b57](https://github.com/propeller-heads/tycho-execution/commit/5228b5726fa2065dc5c2fb1ea359067541781b42))
* Apply slither's suggestions on variable naming ([f941924](https://github.com/propeller-heads/tycho-execution/commit/f94192442b172dadf9d0cb24a61c577400d0f214))
* Fix BalancerV3 and Ekubo ([a5f8422](https://github.com/propeller-heads/tycho-execution/commit/a5f84222fad6a60b2f24107da9d020f713a6ac41))
* Fixes after merging main (Uniswap v2 improvement) ([24a8102](https://github.com/propeller-heads/tycho-execution/commit/24a8102e882a07ff39870950245f0223ad2002c0))
* Remove unnecessary method from Univ4Executor ([900baa2](https://github.com/propeller-heads/tycho-execution/commit/900baa2cee7e4a10bfe6e6dddb40a89afa5be721))

## [0.6.0](https://github.com/propeller-heads/tycho-execution/compare/0.5.0...0.6.0) (2026-01-15)


### Features

* Optimize UniswapV2 calldata encoding ([4d7c518](https://github.com/propeller-heads/tycho-execution/commit/4d7c51869cc6b0b0e067face5ab3af8ee2aa6658))

## [0.5.0](https://github.com/propeller-heads/tycho-execution/compare/0.4.0...0.5.0) (2026-01-15)


### Features

* add function to apply delta ([4a6108c](https://github.com/propeller-heads/tycho-execution/commit/4a6108ccd1a1ee04fa4344d564a59225c8265a62))
* add methods to TestVault to use internal methods for testing purposes ([c5b715a](https://github.com/propeller-heads/tycho-execution/commit/c5b715ac7d1bdd5274b6569047ac983a0493b5f7))
* add tests for main accounting methods ([7afb19f](https://github.com/propeller-heads/tycho-execution/commit/7afb19ff358cee925febfb204961a90440be7d48))
* add vault accounting methods ([6fbb988](https://github.com/propeller-heads/tycho-execution/commit/6fbb988bd2e8d8592914c4d5db8cc1202fe6c3b9))


### Bug Fixes

* update revert reason in Vault contract to use correct error identifier ([39d3da9](https://github.com/propeller-heads/tycho-execution/commit/39d3da9eaf5f439c632dd594b2ebbc0baf711ad0))

## [0.4.0](https://github.com/propeller-heads/tycho-execution/compare/0.3.1...0.4.0) (2026-01-14)


### Features

* **Ekubo:** Bring tokenOut to highest (swap) level ([230a6a5](https://github.com/propeller-heads/tycho-execution/commit/230a6a586004dd29c0f00feb92b571905988ef49))
* **ERC4636:** infer tokenOut from target and asset ([1e0897f](https://github.com/propeller-heads/tycho-execution/commit/1e0897f370b6563b203ad16d94f3f9145474281e))
* **FluidV1:** Add tokenOut to executor ([6c9b441](https://github.com/propeller-heads/tycho-execution/commit/6c9b44131d3d0e7f8905b519120ee90668f0bfda))
* **Lido:** Infer tokenOut in executor ([67a3d19](https://github.com/propeller-heads/tycho-execution/commit/67a3d19924fd5a8d4964b1f9967640431c8ebcc6))
* **Maverick:** Add tokenOut to executor ([4558e06](https://github.com/propeller-heads/tycho-execution/commit/4558e06894c3064dafbe49da3e2a2b4ead0968a5))
* **Rocketpool:** Infer tokenOut in executor ([8d087be](https://github.com/propeller-heads/tycho-execution/commit/8d087be93106f398caa4162e2954dff6a631407e))
* **UniswapV2:** Add tokenOut to executor calldata ([a290e1a](https://github.com/propeller-heads/tycho-execution/commit/a290e1a9f92eaff5d275ca05adfb0d048a7aceca))

## [0.3.1](https://github.com/propeller-heads/tycho-execution/compare/0.3.0...0.3.1) (2026-01-14)


### Bug Fixes

* Add mint and burn that don't emit an event ([694bfb6](https://github.com/propeller-heads/tycho-execution/commit/694bfb6f20ba9bebe52a5ebe98a19e47cd2786f2))

## [0.3.0](https://github.com/propeller-heads/tycho-execution/compare/0.2.0...0.3.0) (2026-01-13)


### Features

* Remove fund rescuer role ([3ec7477](https://github.com/propeller-heads/tycho-execution/commit/3ec7477f3f58af64a17bde907950280dd82a74e3))

## [0.2.0](https://github.com/propeller-heads/tycho-execution/compare/0.1.0...0.2.0) (2026-01-13)


### Features

* **TychoRouter:** Remove built-in wrap/unwrap mechanism ([c8c948b](https://github.com/propeller-heads/tycho-execution/commit/c8c948b9101fc2d295b3f41dff8c3cb6f50052a1))


### Bug Fixes

* Remove weth from router deployment script ([68c2a51](https://github.com/propeller-heads/tycho-execution/commit/68c2a516c7b887e4849067173c079c5e32b1d1fd))
...
* Introduce Tycho Vault ([ee275f9](https://github.com/propeller-heads/tycho-execution/commit/ee275f9ba1dacdf4b46917cac9ef284c6e0f905b))
...
* Rename tycho-execution -> tycho-contracts ([a2ca0f2](https://github.com/propeller-heads/tycho-execution/commit/a2ca0f2d21cb30f1003d371f67ca54f27c0e8368))
...
* Sync with latest tycho-execution ([ec6ae5a](https://github.com/propeller-heads/tycho-execution/commit/ec6ae5a4b77b1ac3a42702b3ab5157ccf768c2f1))
...
* Remove unnecessary code ([8f7f802](https://github.com/propeller-heads/tycho-execution/commit/8f7f802e1b96a53369e87e206f669688739e3ee5))
