...
pub static POST_PROCESSOR_REGISTRY: LazyLock<HashMap<String, PostProcessorFn>> =
    LazyLock::new(|| {
        ...
        registry
            .insert("ignore_self_balances".to_string(), ignore_self_balances as PostProcessorFn);
        registry.insert(
